...
use crate::api::infrastructure::app_assembler::subscriber::Assembler as SubscriberAssembler;
...
impl AppAssembler {
    #[must_use]
    pub async fn new(_config: &str) -> Self {
        ...
        let subscriber = SubscriberAssembler::new(&Arc::clone(&event_bus)).await;
